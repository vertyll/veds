// =========================================================================
// mail-contracts — Published Language module (DDD).
// =========================================================================
plugins {
    java
    `java-library`
...
val avroContractsDir = file("$rootDir/../contracts/mail-service")
...
val generateAvroJava by tasks.registering(JavaExec::class) {
    group = "build"
    description = "Generate Java SpecificRecord classes from all Avro schemas owned by the mail bounded context."
    inputs
        .files(avroSchemas)
